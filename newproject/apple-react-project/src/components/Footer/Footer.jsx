import flogo from "../images/icons/16.png";
const Footer = () => {
  return (
    <div>
      <footer className="footer-wrapper">
        ...
        <div className="footer-links-wrapper">
          ...
          <div className="links-wrapper-4">
            ...
            <ul>
              <li>
                <a href="#">Apple and Businuss</a>
              </li>
              <li>
                <a href="#">Shop for Businuss</a>
              </li>
            </ul>
            <h3>For Edication</h3>
            <ul>
              <li>
                <a href="#">Apple and Eduction</a>
              </li>
              <li>
